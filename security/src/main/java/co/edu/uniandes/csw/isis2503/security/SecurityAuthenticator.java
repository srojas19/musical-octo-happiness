...
public class SecurityAuthenticator implements Authenticator {
    ...
    public boolean validarToken(UserDTO user) {
        ...
        String path = "/Users/BarraganJeronimo/Universidad/Arquitectura de SW/Repositorio/proyecto-corazon/corazon-web/src/main/webapp/WEB-INF/apiKey.properties";//Colocar la Ubicacion de su archivo apiKey.properties
